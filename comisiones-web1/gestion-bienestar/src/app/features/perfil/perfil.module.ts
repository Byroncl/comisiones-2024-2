...
@NgModule({
  declarations: [PerfilComponent, PerfilContentComponent, PerfilFooterComponent, PerfilNavbarComponent],
  imports: [CommonModule, NgbModule, PerfilRoutingModule, NgbAccordionModule, FormsModule],
})
